...
\lstset{ %
	...
	otherkeywords={*,state, shallow,history,final,transition,table,initial,machine,transition,choice,exit,point,entry, port, part, requires, provides, bindPorts, configuration,...},           % if you want to add more keywords to the set
