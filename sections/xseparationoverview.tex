...
Therefore, the \tb{Extended code} containing the additional constructs is syntactically conforming to the standard programming language. 
...
\tb{Extended code} is transformed into \tb{Standard code}. \tb{Extended code} and \tb{Standard code} are then combined with each other to be executed.
