...
Specifically, the behavior of an \ttt{ActiveClass} is described by a state machine\footnote{%It is possible to have multiple state machines in the same active class. However, 
