...
\noindent
\tb{Textual modeling (TMLs) and architecture description (ADLs) languages:} TMLs such as Umple \cite{lethbridge2010umplification} and textual ADLs can have bidirectional mapping to UML elements.
...
Furthermore, ArchJava it not standard Java and facilities of IDEs such as auto-completion are not compatible.%, XSeparation-generated code can use these facilities as discussed in \ref{sec:xseparationarchitecture}.
