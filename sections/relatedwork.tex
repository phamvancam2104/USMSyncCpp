...
from \ttt{user-code} regions which can be edited by the programmers.
...
For the separation of generated and non-generated code, approaches using specialized comments require programmers having a very high discipline.
