...
In this paper, we propose \tb{XSeparation} - an extreme separation code generation and synchronization approach, which enables the bidirectional traceability between architecture model 
