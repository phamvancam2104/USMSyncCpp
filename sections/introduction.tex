...
The surveys described in \cite{Hutchinson:2011:MEP:1985793.1985882} and \cite{Hutchinson:2011:EAM:1985793.1985858} polled MDE practitioners. 
...
In this paper, we tackle the problem of synchronization between model, which includes both structural and behavioral elements, and \ttt{C++} code for developing event-driven systems.
