...
This paper proposes \tb{XSeparation} - an extreme separation code generation and synchronization approach. 
%, which consists of structure and behavior models
The core idea is to leverage an object-oriented language by engineering additional constructs to it in order to enable the bidirectional traceability between architecture model and code.
