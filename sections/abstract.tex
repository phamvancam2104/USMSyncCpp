...
Some tools only produce skeleton code which is then tailored by programmers for fine-grained.
The modifications in the code might violate the architecture correctness, which raises the problem of consistency between architecture and implementation code.
